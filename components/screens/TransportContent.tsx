            ...
            >
                ...
                <View style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}>
                    ...
                    <TouchableOpacity style={[styles.websiteButton, { backgroundColor: theme.primary }]} onPress={openCTSWebsite}>
                        <Text style={[styles.websiteButtonText, { color: theme.background }]}>{i18n.t('visitCTS')}</Text>
                        <IconSymbol name="arrow.up.right" size={16} color={theme.background} />
                    </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    websiteButtonText: { fontWeight: 'bold', marginRight: 8 },
    mapContainer: {
        height: 200,
        margin: 20,
        borderRadius: 8,
